...
import DataStatistics from "./TableTotalData_json";
      ...
      <div className="w-[99.5%]  flex flex-col justify-center items-center gap-2">
        <div className="w-[99.5%] h-auto  flex justify-center items-start  gap-2 flex-wrap ">
          ...
          <div className=" h-[260px] flex flex-1 justify-center flex-col rounded">
            <div className=" min-h-[35px] text-center flex justify-center items-center bg-[#c6c6c6] rounded-t-md text-sm">
              DLTK tổng thu hoạch
            </div>
            <div className=" h-[225px] border-[0.3px] border-[#c6c6c670]">
              <DataStatistics tongCong={data["table"]} />
            </div>
          </div>
        </div>
